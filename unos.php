...
// KONEKTOVANJE NA BAZU
	...
	$EvidencijaObject = new DBProizvodjac($KonekcijaObject, "Proizvodjac");
	$EvidencijaObject->UcitajKolekcijuSvihProizvodjaca();
	$KolekcijaZapisa= $EvidencijaObject->Kolekcija;
	$UkupanBrojZapisa= $EvidencijaObject->BrojZapisa;
...
<meta charset="UTF-8">
<head>
<title>Евиденција реализоване производње</title>
<meta charset="UTF-8">
