...
// koristimo klasu za poziv procedure za konekciju
    ...
    {	
		...
		$EvidencijaViewObject = new DBEvidencijaRealizovaneProizvodnje($KonekcijaObject,"EvidencijaRealizovaneProizvodnje");
		if (isset($_GET['filtriraj']))
			{
				// prikaz filtriranih podataka primenom pogleda nad kojim je dodat filter
				$filter=$_GET['filter'];
				$EvidencijaViewObject->DajSvePodatkeOEvidencijiProizvodnje($filter);
...
<meta charset="UTF-8">
<head>
<title>Евинденција реализоване производње</title>
<meta charset="UTF-8">
...
<td style="width:17%;padding:0" cellspacing="0" cellpadding="0" border="0" valign="top">
...
<?php include 'delovi/desnoEvidencijaRealizovaneProizvodnjeLista.php';?>
</td>
